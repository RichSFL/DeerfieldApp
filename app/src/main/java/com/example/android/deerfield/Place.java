...
public class Place {
     ...
     */
    public Place(int defaultTranslationId, int miwokTranslationId, int audioResourceId) {
     ...
     * @param audioResourceId is the resource ID for the audio file associated with this word
     */
    public Place(int defaultTranslationId, int miwokTranslationId, int imageResourceId,
                 int audioResourceId) {
        mDefaultTranslationId = defaultTranslationId;
        mMiwokTranslationId = miwokTranslationId;
